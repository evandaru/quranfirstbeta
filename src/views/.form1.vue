                ...
                <div>
                    <form @submit.prevent="submitForm">
                        ...
                        <div v-for="item in  inputData " :key="item.name">
                            <component :is="item.tag" :placeholder="item.placeholder" :v-model="[item.name]"
                                :class="item.class">
...
const inputData = [
    {
        tag: 'input', name: 'nama', placeholder: 'nama lengkap',
        inputType: 'text',
        class: classInput
    },
    {
        tag: 'select', name: 'jenis_kelamin', placeholder: 'jenis kelamin',
        class: classInput,
        options: [
    ...
    {
        tag: 'input', name: 'domisili', placeholder: 'domisili',
        inputType: 'text',
        class: classInput
    },
    {
        tag: 'input', name: 'no_wa', placeholder: 'No HP',
        inputType: 'text',
        class: classInput
    },
    {
        tag: 'input', name: 'usia', placeholder: 'Usia',
        inputType: 'text',
        class: classInput
    },
    {
        tag: 'select', name: 'program', placeholder: 'jenis kelamin',
        class: classInput,
        options: [
    ...
    {
        tag: 'select', name: 'tingkat', placeholder: 'tingkat',
        class: classInput,
        options: [
